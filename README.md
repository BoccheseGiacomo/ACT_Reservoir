...
Since i discovered that with that work i re-invented the ACT paradigm in a totally independent way, and after discovering the work of A.Graves on ACT i decided to put that name to my work rather then SCRN and merging a bit the functionalities.
